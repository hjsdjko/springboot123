...
public class XueshengController {
    ...
    public R register(@RequestBody XueshengEntity xuesheng){
		...
		xuesheng.setId(uId);
        xuesheng.setMima(EncryptUtil.sha256(xuesheng.getMima()));
    ...
    public R security(@RequestParam String username){
        XueshengEntity xuesheng = xueshengService.selectOne(new EntityWrapper<XueshengEntity>().eq("xuehao", username));
        return R.ok().put("data", xuesheng);
    }
